...
class AIParserService:
    ...
    async def parse_contract(self, document_url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not processing_result.validation_ready:
                logger.warning(f"Document processing completed with issues: {processing_result.processing_errors}")
            ...
            if processing_result.contract_data:
                ...
                logger.warning("No contract data extracted despite successful processing")
                return self._get_fallback_data()
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "healthy" if processor_health["status"] == "healthy" and gemini_health["status"] == "healthy" else "degraded",
...
_ai_parser_service: Optional[AIParserService] = None
